...
function draw() {
 ...
 { 
  ...
  fill(222, 222, 222);
    ...
    textSize(6);
    text("By obtaining 5 keys, you can open the final door", 110, 6730);
    textSize(6);
    text("Conquer the Enigma Realm and finish the maze!", 110, 6740);

    textSize(18);
    text("Congratulations!", 230, 8810);
    textSize(18);
    text("You conquered the Enigma Realm!", 160, 8980);
